...
frutas = ["maca", "melancia", "laranja", "morango", "uva", "1", "2", "3", "4", "5", "cachorro", "gato", "elefante", "leao", "tigre", "pai", "mae", "irmao", "irma", "avo", "vovô"]

traducao = ["Apple", "Watermelon", "Orange", "Strawberry", "Grape", "One", "Two", "Three", "Four", "Five", "Dog", "Cat", "Elephant", "Lion", "Tiger", "Father", "Mother", "Brother", "Sister", "Grandmother", "Grandfather"]
...
def jogar_jogo():
    ...
    for i, opcao in enumerate(opcoes):
        botao_opcao = tk.Button(janela, text=opcao, font=("Times New Roma", 16), width=15, height=2, command=lambda x=i+1: verificar_resposta(x, traducao_correta, fruta, opcoes, janela))
        botao_opcao.pack()
    def fechar_janela():
        janela.destroy()
